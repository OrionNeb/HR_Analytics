...
library(rpart)
#Recursive Partitionierung und Entscheidungsbäume für Regression und Klassifikation zu erstellen

library(randomForest)
#Erstellen von Random-Forest-Modelle
...
### 3.2.3 Neues Modelling - Random Forest 2
